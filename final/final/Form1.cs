    ...
    public partial class Form1 : Form
    {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand komut3 = new SqlCommand("update  sepet set toplamfiyati=miktari * satisfiyati where barkodno='"+txtBarkodNo.Text+"'", baglanti); //barkod no yazılan yerde carpma yapar
        ...
        private void btnSatışYap_Click(object sender, EventArgs e)
        {
            ...
            sepetlistele();
            hesapla();
            MessageBox.Show("Seçilen ürünler satıldı");
        }
    }
}
